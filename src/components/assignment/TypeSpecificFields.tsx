                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <TextField
                                ...
                                multiline
                                rows={3}
                                {...register(`${basePath}.question` as const)}
                        ...
                        <Grid item xs={12} md={6}>
                            <TextField
                                ...
                                helperText={`Index from 0 to ${Math.max(0, ((val('options') as string[]) || []).length - 1)}`}
                            />
                        </Grid>
                    </Grid>
                </Paper>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <TextField
                                fullWidth
                                label="Audio URL"
                                {...register(`${basePath}.audioUrl` as const)}
                        ...
                        <Paper key={i} sx={{ p: 2, mb: 2, bgcolor: 'grey.50' }}>
                            <Grid container spacing={2} alignItems="center">
                                ...
                                <Grid item xs={12} md={5}>
                                    <TextField
                                        fullWidth
                                        label="Sample Audio URL (Optional)"
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <TextField
                                ...
                                multiline
                                rows={3}
                                {...register(`${basePath}.prompt` as const)}
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <TextField
                                fullWidth
                                label="Scenario"
                                {...register(`${basePath}.scenario` as const)}
                        ...
                        <Grid item xs={12}>
                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                                ...
                                <Button
                                    ...
                                    size="small"
                                    onClick={() => {
                                        const passage: string = watch(`${basePath}.passage` as const) || '';
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} md={6}>
                            <TextField
                                fullWidth
                                label="Target"
                                {...register(`${basePath}.target` as const)}
