...
const SessionSchedules = ({ control, register, errors, setValue, watch }: SessionSchedulesProps) => {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl border border-blue-100 mt-8">
      ...
      <div className="mb-6">
        ...
        <input
          ...
          className="w-full md:w-1/3 px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                        ...
                        {watch(`sessionSchedules.${index}.activities`)?.map((activity: SessionActivityDto, actIdx: number) => {
                          ...
                          return (
                            <div key={actIdx} className="flex items-center justify-between bg-white p-2 rounded border border-gray-200">
                              <div className="flex items-center">
                                <span className="bg-purple-100 text-purple-700 text-xs px-2 py-1 rounded mr-2">
                                  {activity.orderNo}
                                </span>
