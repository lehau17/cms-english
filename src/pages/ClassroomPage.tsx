            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-4 sm:mb-6 md:mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
                    <div className="min-w-0 flex-1">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-1 sm:mb-2">Classroom Management</h1>
                        <p className="text-sm sm:text-base text-gray-600">Oversee all classrooms and their activities.</p>
                    </div>
                    <button
                                            ...
                                            {classrooms.map((classroom) => (
                                                <tr key={classroom.id} className="hover:bg-gray-50 transition-colors">
                                                    <td className="px-3 sm:px-6 py-3 sm:py-4">
                                                        <div className="font-semibold text-gray-900 text-sm">{classroom.name}</div>
                                                        <div className="text-xs sm:text-sm text-gray-500">Code: {classroom.classCode}</div>
                                                    </td>
                                                    <td className="px-3 sm:px-6 py-3 sm:py-4">
                                                        <div className="flex items-center space-x-2">
                                                            <User className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-400 flex-shrink-0" />
                                                            <span className="text-xs sm:text-sm truncate">{classroom.teacher?.firstName} {classroom.teacher?.lastName}</span>
                                                        </div>
                                                    </td>
                                                    <td className="px-3 sm:px-6 py-3 sm:py-4">
                                                        <div className="relative">
                                                            ...
                                                            {statusDropdownOpen === classroom.id && (
                                                                <div className="absolute z-10 mt-2 w-40 sm:w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                                                                    <div className="py-1" role="menu">
                                                                        <div className="px-3 sm:px-4 py-2 text-xs text-gray-500 font-semibold">Change Status</div>
                                                    ...
                                                    <td className="px-3 sm:px-6 py-3 sm:py-4">
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <span className="text-xs sm:text-sm">{classroom.students?.length || 0} / {classroom.maxStudents || '∞'}</span>
                                                        </div>
                                                    </td>
                                                    <td className="px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm text-gray-500">{formatDate(classroom.createdAt)}</td>
                                                    <td className="px-3 sm:px-6 py-3 sm:py-4">
