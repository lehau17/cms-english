      ...
      <div className="relative flex items-start justify-center min-h-screen px-4 pt-10 pb-10 text-center">
        ...
        <div className="relative z-10 inline-block w-full max-w-5xl overflow-y-auto text-left align-bottom transition-all transform bg-white shadow-xl rounded-2xl sm:my-8 sm:align-middle max-h-[90vh]">
          ...
          <div className="relative">
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-4 flex-shrink-0 bg-white bg-opacity-90 hover:bg-opacity-100 rounded-full p-2 transition-all duration-200 shadow-lg"
            >
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              <h1 className="text-2xl font-semibold text-gray-900 mb-2 break-words">{course.title}</h1>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-xl">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-purple-900">{formatVNDAlways(course.price)}</p>
                  </div>
