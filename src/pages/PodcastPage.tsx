...
import { PodcastCategory, PodcastDifficulty, PodcastStatus } from "@/interface/podcast.interface";
                            ...
                            <TableRow key={podcast.id}>
                                    ...
                                    <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                                        ...
                                        <Box>
                                            ...
                                            <Typography variant="caption" color="text.secondary">
                                                {podcast.mediaType.toUpperCase()} • {podcast.durationFormatted || "00:00"}
                                            </Typography>
                                        </Box>
                                    </Box>
                                </TableCell>
                                ...
                                <TableCell>
                                    <Chip
                                        ...
                                        color={podcast.status === PodcastStatus.PUBLISHED ? "success" : "default"}
                                        size="small"
                                    />
                                </TableCell>
